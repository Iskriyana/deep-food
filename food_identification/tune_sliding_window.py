...
def main(logdir, colab):
    ...
    #colab = False
    if colab:
        new_data_directories = [str(Path().absolute().parents[0]/'data/FIDS30'),
        ...
        new_real_validation_path = str(Path().absolute().parents[0]/'data/validation_real')
        new_artificial_validation_path = str(Path().absolute().parents[0]/'data/validation_artificial')
